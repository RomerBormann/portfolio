...
class ContactController {
    ...
    public function handleContactForm() {
        ...
        if( count( $errors ) === 0 ) {
            ...
            $message = createEmailMessage('contact@romerbormann.net', 'Portfolio | Contact Form Response', $from_name, $from_email);
            ...
            $template_engine = get_template_engine();
            echo $template_engine->render('website', ['success' => $success]);
            exit;

        }

        $template_engine = get_template_engine();
        echo $template_engine->render('website', ['errors' => $errors]);
